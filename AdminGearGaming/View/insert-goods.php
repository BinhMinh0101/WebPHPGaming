...
<body>
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        ...
                        if (isset($_POST['submitAddGoods'])) {
                            ...
                            $goodsDetail->addGoods($idProducts, $Tensanpham, $Anh, $soLuong, $donGia, $SoLuongDangCo);
                        }
                        ?>
                    </div>
                </div>
                ...
                <div class="panel panel-default">
                    ...
                    if (isset($_REQUEST['thanhToan']) && isset($_SESSION['goods'])) {
                        ...
                        foreach ($_SESSION['goods'] as $item_goods) {
                            ...
                            $goodsDetail->addGoodsDetail($array_detail);

                            $s->congSanPham($maSanPham, $qty);
                        }
                        $goodsDetail->deleteGoods();
    ...
    if (isset($_REQUEST['action']) && $_REQUEST['action'] == 'deleteProduct') {
        $goodsDetail->deleteProduct($_REQUEST['idProduct']);
    ...
    if (isset($_REQUEST['updateGoods'])) {
        $goodsDetail->updateGoods($_REQUEST['slGoods'], $_REQUEST['dgGoods']);
        header('location:insert-goods.php');
    }
    ?>
